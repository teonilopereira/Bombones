...
namespace Bombones.IoC
{
    public static class DI
    {
        public static IServiceProvider ConfigurarServicios()
        {
            ...
            service.AddScoped<IRepositorioFormasDeVenta, RepositorioFormasDeVenta>();
            ...
            service.AddScoped<IServiciosFormasDeVenta>(sp =>
            {
                var repositorio = new RepositorioFormasDeVenta();
                return new ServiciosFormasDeVenta(repositorio, cadena);
            });
